module.exports = {
    ...
    "@blockpool-io/core-p2p": {
        server: {
            port: process.env.CORE_P2P_PORT || 20930,
        },
    ...
    "@blockpool-io/core-api": {
        ...
        port: process.env.CORE_API_PORT || 29031,
    },
    ...
    "@blockpool-io/core-webhooks": {
        ...
        server: {
            ...
            port: process.env.CORE_WEBHOOKS_PORT || 29032,
    ...
    "@blockpool-io/core-exchange-json-rpc": {
        ...
        port: process.env.CORE_EXCHANGE_JSON_RPC_PORT || 29034,
        allowRemote: false,
        whitelist: ["127.0.0.1", "::ffff:127.0.0.1"],
    },
