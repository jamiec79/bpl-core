...
import { Builders as MagistrateBuilders } from "@blockpool-io/core-magistrate-crypto";
import { Managers, Transactions, Validation } from "@blockpool-io/crypto";
...
describe("Bridgechain registration transaction", () => {
    ...
    describe("Schema tests", () => {
            ...
            it("should fail because name should not be empty (at least 1 char)", () => {
                const bridgechainRegistration = builder
                    .bridgechainRegistrationAsset({
                        ...
                        ports: { "@blockpool-io/core-api": 12345 },
                    })
                    .sign("passphrase");
        ...
        describe("should test edge cases for ports", () => {
            it.each([["empty is invalid", {}], ["needs to include core-api", { "@blockpool-io/not-core-api": 123 }]])(
            ...
            it.each([
                [{ "@blockpool-io/core-api": 123 }],
                [{ "@blockpool-io/core-api": 123, "@valid/pa_ckage-name": 124 }],
                [{ "@blockpool-io/core-api": 123, "valid-package_name": 124 }],
                [{ "@blockpool-io/core-api": 123, "@invalid/UPPERCASE": 124 }],
                [{ "@blockpool-io/core-api": 123, "@invalid/char)": 124 }],
