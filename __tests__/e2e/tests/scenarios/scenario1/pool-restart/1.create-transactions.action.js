...
const { Managers, Identities } = require("@blockpool-io/crypto");
...
module.exports = async options => {
    ...
    const commandDisconnectNode = `docker network disconnect nodes $(docker ps --format "{{.Names}}" | grep node1_bpl)`;
